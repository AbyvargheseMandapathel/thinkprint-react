...
export default async function handler(req, res) {
  const allowedOrigins = ['http://localhost:5173', 'https://thinkprint.shop','https://thinkprint-react.vercel.app/', 'https://think-print-anvogue.vercel.app', 'http://localhost:3000'];
